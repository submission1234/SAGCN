...
def extract_videos_on_csv(csv_file: str, video_dir: str, out_dir: str,
    ...
    for idx, file_name in enumerate(df.video_name):
        ...
        n = total_frames // frames  # 在这里取的帧 frames决定了取几帧 在definitions里面定义的
...
if __name__ == '__main__':
    ...
    if preprocess_train:
        extract_videos_on_csv(TRAIN_CSV, TAU_VIDEO_DIR, IMAGE_TRAIN_DIR)
        generate_image_csv_from_dir_csv(csv_in=TRAIN_CSV,
